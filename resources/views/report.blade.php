...
<div class="my-5">
    ...
    <h4 class="mb-4">Report Catatan Makanan {{ auth()->user()->username }}</h4>
    <table class="table table-bordered" border="1" style="border-collapse: collapse">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $catatanTanggal[0]->jam }}</td>
                <td class="text-center">{{ $catatanTanggal[0]->makanan->nama }}</td>
                <td class="text-center">{{ $catatanTanggal[0]->jumlah }}</td>
                <td class="text-center">{{ $catatanTanggal[0]->makanan->karbohidrat * $catatanTanggal[0]->jumlah }}</td>
                <td class="text-center">{{ $catatanTanggal[0]->makanan->protein * $catatanTanggal[0]->jumlah }}</td>
                <td class="text-center">{{ $catatanTanggal[0]->makanan->garam * $catatanTanggal[0]->jumlah }}</td>
                <td class="text-center">{{ $catatanTanggal[0]->makanan->gula * $catatanTanggal[0]->jumlah }}</td>
                <td class="text-center">{{ $catatanTanggal[0]->makanan->lemak * $catatanTanggal[0]->jumlah }}</td>
            </tr>
            @foreach ($catatanTanggal->skip(1) as $catatan)
            <tr>
                <td class="text-center">{{ $catatan->jam }}</td>
                <td class="text-center">{{ $catatan->makanan->nama }}</td>
                <td class="text-center">{{ $catatan->jumlah }}</td>
                <td class="text-center">{{ $catatan->makanan->karbohidrat * $catatan->jumlah }}</td>
                <td class="text-center">{{ $catatan->makanan->protein * $catatan->jumlah }}</td>
                <td class="text-center">{{ $catatan->makanan->garam * $catatan->jumlah }}</td>
                <td class="text-center">{{ $catatan->makanan->gula * $catatan->jumlah }}</td>
                <td class="text-center">{{ $catatan->makanan->lemak * $catatan->jumlah }}</td>
            </tr>
            @endforeach
            @endforeach
            <tr>
