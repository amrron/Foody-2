<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="jenis_kelamin" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="jenis_kelamin" value="old('jenis_kelamin')" required autofocus autocomplete="name" >
        ...
        <div class="mt-4">
            ...
            <input type="date" id="tanggal_lahir" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="tanggal_lahir" value="old('tanggal_lahir')" required autofocus autocomplete="name"/>
        ...
        <div class="flex mt-4">
            ...
            <div class="w-1/2 ms-2">
                ...
                <input type="number" id="berat_badan" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="berat_badan" value="old('berat_badan')" required autofocus autocomplete="name"/>
        ...
        <div class="mt-4">
            ...
            <select id="aktivitas" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="aktivitas" value="old('aktivitas')" required autofocus autocomplete="name" >
                <option value="" disabled selected hidden></option>
