...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 min-h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="min-h-screen px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      <ul class="space-y-2 font-medium">
         <li>
            <x-side-link href="{{ route('admin.dashboard') }}" :active="request()->routeIs('admin.dashboard')" class="flex items-center p-2 text-biru rounded-lg dark:text-white  dark:hover:bg-gray-700 group">
               <svg class="w-5 h-5 text-biru transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
         ...
         <li>
            <x-side-link href="{{ route('admin.user') }}" :active="request()->routeIs('admin.user')" class="flex items-center p-2 text-biru rounded-lg dark:text-white dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-biru transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
         ...
         {{-- <li>
            <a href="#" class="flex items-center p-2 text-biru rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-biru transition duration-75 dark:text-gray-400 group-hover:text-biru dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-biru rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-biru transition duration-75 dark:text-gray-400 group-hover:text-biru dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
