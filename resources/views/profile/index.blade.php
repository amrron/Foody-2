                    ...
                    <div class="flex justify-center items-center">
                        <div class=" w-full">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="w-full bg-gray-200 rounded-full dark:bg-gray-700 overflow-hidden">
                                    <div class="bg-birumuda text-xs font-medium text-biru text-center p-0.5 leading-none rounded-full" style="width: {{ round($user->dailyProtein / $user->batasProtein * 100) }}%"> {{ round($user->dailyProtein / $user->batasProtein * 100) }}%</div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="flex justify-between">
