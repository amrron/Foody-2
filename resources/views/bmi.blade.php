                ...
                <form action="/bmi" method="post" id="calculator" class="flex flex-wrap max-w-screen-md mx-auto">
                    ...
                    <div class="flex w-full">
                        <div class="w-full sm:w-1/2 px-2 mt-3">
                            <button type="reset" class="btn w-full bg-birumuda text-biru text-4xl hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Reset</button>
                        </div>
                        <div class="w-full sm:w-1/2 px-2 mt-3">
